...
X(ResolveExternalSymbols       , 0x435014332417BLL             , ResolveExternalSymbols        )
X(ResolvedSymbols              , 0x4350143D267B0LL             , ResolvedSymbols               )
X(ReserveMemorySpaces          , 0x4353443737041LL             , ReserveMemorySpaces           )
